...
#    Updated: 2019/09/27 19:11:31 by vhazelnu         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = lem_in.c hash_func.c validation/validate_coords.c validation/find_and_connect_rooms.c bfs.c bellman_ford.c run_ants.c find_shortest_path.c delete_dup_rooms.c print_graph.c \
		...
		validation/work_with_data.c qsort.c work_with_path.c push_ants_from_start.c push_ants_to_end.c create_paths_new.c create_dup_rooms.c reverse_edges.c is_enough_paths.c \
		find_disjoint_paths.c manage_directions.c \
